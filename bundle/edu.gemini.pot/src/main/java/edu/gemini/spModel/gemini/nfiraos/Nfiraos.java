...
/**
 * The data object for the Nfiraos observation component.
 */
public final class Nfiraos extends AbstractDataObject implements PropertyProvider, GuideProbeProvider, GuideProbeConsumer {
    ...
    public static final String SYSTEM_NAME = "Nfiraos";
    ...
    private static PropertyDescriptor initProp(String propName) {
        ...
        pd = PropertySupport.init(propName, Nfiraos.class, true, false);
