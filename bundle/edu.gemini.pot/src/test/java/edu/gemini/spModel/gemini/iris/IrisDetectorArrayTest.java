...
/**
 * Test cases for the {@link IrisDetectorArray}.
 */
public class IrisDetectorArrayTest extends TestCase {
    ...
    private void assertEmpty(Coordinates[] coordsArray) {
        Option<IrisDetectorArray.Id> idOpt;
        for (Coordinates coords : coordsArray) {
            idOpt = IrisDetectorArray.instance.getId(coords, baseContext);
    ...
    private void assertOrdered(Coordinates[] coordsArray, ObsContext ctx) {
        ...
        Option<IrisDetectorArray.Id> idOpt;
        for (Coordinates coords : coordsArray) {
            idOpt = IrisDetectorArray.instance.getId(coords, ctx);
