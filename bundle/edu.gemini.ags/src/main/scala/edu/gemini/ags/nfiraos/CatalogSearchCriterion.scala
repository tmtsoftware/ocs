...
import edu.gemini.spModel.nfiraos.{NfiraosGuideProbeGroup, NfiraosGuideStarType}
 ...
 * See OT-24
 */
case class NfiraosCatalogSearchCriterion(key: NfiraosCatalogSearchKey, criterion: CatalogSearchCriterion)

/**
 * Results of a Nfiraos catalog search
 * See OT-24
 */
case class NfiraosCatalogSearchResults(criterion: NfiraosCatalogSearchCriterion, results: List[SiderealTarget]) {
  // Constructors for Java
  def this(results: java.util.List[SiderealTarget], criterion: NfiraosCatalogSearchCriterion) = this(criterion, results.asScala.toList)
...
/**
 * Represents the Nfiraos catalog star options
 * See OT-24
 */
case class NfiraosCatalogSearchKey(starType: NfiraosGuideStarType, group: NfiraosGuideProbeGroup)
