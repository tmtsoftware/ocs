...
import edu.gemini.ags.nfiraos.NfiraosResultsAnalyzer;
import edu.gemini.ags.nfiraos.mascot.Mascot;
import edu.gemini.ags.nfiraos.mascot.MascotConf;
import edu.gemini.ags.nfiraos.mascot.Star;
...
public class StrehlFeature extends TpeImageFeature implements PropertyWatcher, MouseListener {
    ...
    private scala.Option<Strehl> computeStrehlFromTargetList(List<SPTarget> targetList, GuideProbe.Type type) {
        ...
        double factor = NfiraosResultsAnalyzer.instance().getStrehlFactor(this.getContext().obsContextJava());
