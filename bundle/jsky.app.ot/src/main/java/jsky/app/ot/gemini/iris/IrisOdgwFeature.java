...
import edu.gemini.spModel.gemini.iris.IrisDetectorArray.Quadrant;
 ...
 */
public final class IrisOdgwFeature extends TpeImageFeature {
    private boolean isEmpty;

    public IrisOdgwFeature() {
    ...
    public void draw(Graphics g, TpeImageInfo tii) {
        ...
        tups = IrisDetectorArray.instance.quadrantIntersection(offsets);
    ...
    @Override public boolean isEnabled(TpeContext ctx) {
        ...
        return ctx.instrument().is(Iris.SP_TYPE);
    }
