 ...
 * Nfiraos AO class
 */
public class Nfiraos implements AOSystem {
    /**
     * Related files will be in this subdir of lib
     */
    public static final String NFIRAOS_LIB = "/nfiraos";
     ...
     */
    public static final String NFIRAOS_BACKGROUND_FILENAME = "background";

    /**
     * Name of the Nfiraos transmission file
     */
    public static final String NFIRAOS_TRANSMISSION_FILENAME = "transmission";

    private double wavelength, uncorrectedSeeing;
    private static final double geometricFactor = 1.0;

    private NfiraosBackgroundVisitor nfiraosBackground;
    private NfiraosTransmissionVisitor nfiraosTransmission;
    ...
    //Constructor
    public Nfiraos(double wavelength, double uncorrectedSeeing, double avgStrehl,
                String strehlBand, SPSiteQuality.ImageQuality iq, SourceDefinition source) {
        nfiraosBackground = new NfiraosBackgroundVisitor();
        nfiraosTransmission = new NfiraosTransmissionVisitor();
    ...
    // calculations involving Nfiraos (IRIS, F2+Nfiraos in the future).
    //
    ...
    // "Nfiraos cannot be used in IQ=Any conditions"
    //
    ...
    public double getAOCorrectedFWHM(boolean doThrow) {
        if (source.profile() == PointSource$.MODULE$) {
            ...
            switch (strehlBand.charAt(0)) {
                ...
                default:
                    throw new IllegalArgumentException("Current ITC implementation for Nfiraos does not support band " + strehlBand);
            }
        ...
        if (doThrow) {
            ...
            throw new IllegalArgumentException("Nfiraos cannot be used in IQ=Any conditions");
        } else {
